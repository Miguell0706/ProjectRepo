  ...
  return (
    <section className="about">
      <div className="who-are-we">
        <h2>Who Are We ?</h2>
        <p>
          Welcome to <bold>“YourYouthBook”!</bold> We are a special place where
          you can capture and cherish all the precious moments of your child.
          Whether it's the first smile, the first steps or birthday parties,
          here you can share and save everything.
        </p>
        <ul>
          <li>
            <div>
              ...
              <p>
                Safe and Private: You have complete control over who can access
                the website. Only you and your immediate family can view the
                memories .
              </p>
            </div>
          </li>
          <li>
            <div>
              <h3>Easy to Use</h3>
              <p>
                Our intuitive interface makes it easy to add photos and stories.
        ...
        <ul>
          <li>
            ...
            <div>
              ...
              <p>
                Photos and Videos: Upload photos and videos of your child. From
                cute baby photos to school performances, anything is welcome!
              </p>
            </div>
          </li>
          <li>
          ...
          <li>
            ...
            <div>
              ...
              <p>
                ...
                Think of Grandpa and Grandma but also the teacher of the primary
                school or the maternity care.
              </p>
            </div>
          </li>
        </ul>
